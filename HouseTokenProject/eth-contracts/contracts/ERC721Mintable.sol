...
contract Ownable {
    ...
    modifier onlyOwner(){
        require(_owner == msg.sender, "The user is not the creater of the contract");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
       ...
       require(newOwner != address(0), "It is not a real address");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender == getOwner() || isApprovedForAll(getOwner(), msg.sender), "Sender is not the approved address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "From address is not the owner of given address");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "to address for transfer is not a valid");    
...
contract HouseToken is ERC721Metadata("HouseToken", "HT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
